...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((a,b) => map[a.dayOfWeek.toLowerCase()]-map[(b.dayOfWeek.toLowerCase())]);
  return arr;
};
...
const sortSchedule = (arr) => {
  const startArr = arr.sort((a,b) => map[a.dayOfWeek.toLowerCase()]-map[(b.dayOfWeek.toLowerCase())]);
 startArr.sort((a,b) => {
  if(a.dayOfWeek == b.dayOfWeek && a.start == b.start){
    return a.end - b.end;
  } else if (a.dayOfWeek == b.dayOfWeek && a.start !== b.start){
